  ...
  return (
    <div className="app">
      ...
      <aside className={`sidebar${sidebarOpen ? " sidebar--open" : ""}${sidebarCollapsed ? " sidebar--collapsed" : ""}`}>
        ...
        {sidebarCollapsed && (
          <div className={`status-dot-centered ${ollamaOk ? "status-dot-centered--ok" : "status-dot-centered--err"}`}
            title={`Ollama ${ollamaOk ? "online" : "offline"}`}
          />
        )}

        {/* Model Panel (hidden when collapsed) */}
        <ModelPanel
        ...
        {/* Collapsed: show active provider icon */}
        {sidebarCollapsed && (
        ...
        {/* Web Search Toggle */}
        <WebSearchToggle enabled={webSearchEnabled} onChange={setWebSearchEnabled} collapsed={sidebarCollapsed} />
