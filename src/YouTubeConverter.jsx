...
const STEPS = [
  ...
  { id: "transcript", label: "Fetching transcript",   icon: "✍️" },
      ...
      {STEPS.map((step, i) => {
        ...
        return (
          <div key={step.id} style={styles.stepRow}>
            <div style={{
              ...styles.stepDot,
              background: failed ? "#fc8181" : done ? "#68d391" : active ? "#f6ad55" : "#2d3748",
              borderColor: failed ? "#e53e3e" : done ? "#48bb78" : active ? "#ed8936" : "#4a5568",
            ...
            <span style={{
              ...styles.stepLabel,
              color: failed ? "#fc8181" : done ? "#68d391" : active ? "#f6ad55" : "#718096",
...
export default function YouTubeConverter() {
  ...
  const handleConvert = async () => {
    ...
    const advanceSteps = async () => {
      await delay(500);  setCurrentStep("metadata");
      await delay(800);  setCurrentStep("transcript");
      // stays here until fetch completes
    };
    ...
    <div style={styles.root}>
      ...
      <div style={styles.card}>
        ...
        <div style={styles.header}>
          <div style={styles.ytIconWrap}><Icon.YouTube /></div>
          <div>
            <h1 style={styles.title}>YouTube → PDF</h1>
            <p style={styles.subtitle}>Download a timestamped transcript PDF from any captioned video</p>
          </div>
        </div>
        ...
        <div style={styles.infoBanner}>
          ...
          <span>
            Uses YouTube's own captions — <strong>no API key needed</strong>.
            Works on any video with captions (auto-generated or manual).
          </span>
        </div>
        ...
        <div style={styles.fieldGroup}>
          ...
          <div style={{ position: "relative" }}>
            <div style={styles.ytPrefixIcon}><Icon.YouTube /></div>
            <input
              ref={urlInputRef}
              type="url"
        ...
        <div style={styles.noticeBanner}>
          ...
          <span>
            Requires captions to be enabled on the video. If a video lacks captions, the
            conversion will fail with a clear error message.
          </span>
        </div>
...
const styles = {
  ...
  backLink: {
    ...
    color: "#718096", textDecoration: "none", fontSize: 13,
    marginBottom: 20, alignSelf: "flex-start", maxWidth: 520, width: "100%",
  },
  card: {
    background: "#1a1e2e", borderRadius: 16, padding: "32px 28px",
  ...
  ytIconWrap: {
    width: 44, height: 44, flexShrink: 0, color: "#e53e3e",
    filter: "drop-shadow(0 0 8px rgba(229,62,62,0.5))",
  },
  title: {
    margin: 0, fontSize: 24, fontWeight: 700,
    color: "#f7fafc", letterSpacing: "-0.5px",
  },
  subtitle: { margin: "2px 0 0", fontSize: 13, color: "#718096" },
  infoBanner: {
    background: "#1e2d40", border: "1px solid #2b4a6a",
    borderRadius: 8, padding: "10px 14px", fontSize: 13,
    color: "#90cdf4", display: "flex", alignItems: "center", gap: 8,
  },
  noticeBanner: {
    background: "#1e2415", border: "1px solid #2d4a1e",
    borderRadius: 8, padding: "10px 14px", fontSize: 12,
    color: "#9ae6b4", display: "flex", alignItems: "flex-start", gap: 8,
  },
  ...
  input: {
    ...
    border: "1.5px solid #2d3748", borderRadius: 8,
    padding: "10px 12px", color: "#f7fafc", fontSize: 14,
    outline: "none", transition: "border-color 0.2s",
  },
  ytPrefixIcon: {
    position: "absolute", left: 12, top: "50%", transform: "translateY(-50%)",
    width: 18, height: 18, color: "#e53e3e", pointerEvents: "none",
  },
  clearBtn: {
  ...
  urlActions: { display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" },
  smallBtn: {
    background: "#2d3748", border: "1px solid #4a5568", borderRadius: 6,
    color: "#a0aec0", fontSize: 12, padding: "4px 10px", cursor: "pointer",
  },
  validBadge: { fontSize: 12, color: "#68d391", fontWeight: 600 },
  thumbnail: {
    position: "relative", borderRadius: 10, overflow: "hidden",
    border: "1px solid #2d3748", aspectRatio: "16/9", background: "#0f1117",
  },
  thumbnailImg: { width: "100%", height: "100%", objectFit: "cover", display: "block" },
  thumbnailOverlay: {
  ...
  ytPlayBtn: {
    ...
    width: 48, height: 48,
    display: "flex", alignItems: "center", justifyContent: "center",
    color: "white", boxShadow: "0 0 20px rgba(229,62,62,0.6)",
  },
  errorBox: {
    background: "#2d1b1b", border: "1px solid #e53e3e", borderRadius: 8,
    padding: "12px 14px", color: "#fc8181", fontSize: 13, lineHeight: 1.5,
  },
  stepTracker: {
    background: "#141824", borderRadius: 10, padding: "16px 18px",
    border: "1px solid #2d3748",
  ...
  stepLabel: { fontSize: 13, transition: "color 0.3s ease", flex: 1 },
  stepLine: {
    position: "absolute", left: 14, top: 30, width: 2, height: 12,
    transition: "background 0.3s ease",
  },
  successBox: {
    background: "#1a2e1a", border: "1px solid #48bb78", borderRadius: 10,
    padding: "16px 18px", display: "flex", flexDirection: "column", gap: 12,
  },
  successHeader: { display: "flex", alignItems: "center", gap: 12 },
  successTitle: { margin: 0, fontWeight: 700, color: "#68d391", fontSize: 15 },
  successSub: { margin: 0, fontSize: 12, color: "#48bb78", wordBreak: "break-all" },
  downloadBtn: {
    background: "linear-gradient(135deg,#48bb78,#276749)",
    border: "none", borderRadius: 8, color: "white", fontWeight: 700,
    fontSize: 15, padding: "12px 20px", cursor: "pointer",
    display: "flex", alignItems: "center", justifyContent: "center", gap: 8,
    width: "100%", boxShadow: "0 4px 15px rgba(72,187,120,0.3)",
  },
  convertBtn: {
    border: "none", borderRadius: 8, color: "white", fontWeight: 700,
  ...
  resetBtn: {
    ...
    color: "#a0aec0", fontSize: 14, padding: "11px",
